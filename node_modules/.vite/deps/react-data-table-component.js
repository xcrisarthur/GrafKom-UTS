...
var ut = function() {
  function e2() {
    ...
    this._emitSheetCSS = function() {
      var t2 = e3.instance.toString(), n = Se(), o2 = ne([n && 'nonce="'.concat(n, '"'), "".concat(f, '="true"'), "".concat("data-styled-version", '="').concat("6.1.0", '"')].filter(Boolean), " ");
      ...
      if (e3.sealed)
        throw ce(2);
      var r3 = ((n = {})[f] = "", n["data-styled-version"] = "6.1.0", n.dangerouslySetInnerHTML = { __html: e3.instance.toString() }, n), s3 = Se();
